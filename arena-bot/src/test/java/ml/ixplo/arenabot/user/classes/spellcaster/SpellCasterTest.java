...
public class SpellCasterTest extends BaseTest {
    ...
    public void countReceivedSpellPoints() throws Exception {
        Assert.assertEquals(0, SpellCaster.countReceivedSpellPoints(1, 98));
        Assert.assertEquals(1, SpellCaster.countReceivedSpellPoints(2, 118));
        Assert.assertEquals(2, SpellCaster.countReceivedSpellPoints(142, 99));
        Assert.assertEquals(2, SpellCaster.countReceivedSpellPoints(300, 0));
    }
